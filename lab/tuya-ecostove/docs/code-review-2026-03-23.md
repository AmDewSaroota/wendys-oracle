...
| **P0+P1 batch** (RLS, race condition, timezone, timing-safe PIN, CORS, XSS, PM10, ilike→eq, session validate) | ✅ Fixed | 2026-03-24 (P0+P1) |
| A-H1: tuya-devices.js CORS wildcard → restricted | ✅ Fixed | 2026-03-24 (P2) |
| D-H02: showInfo popup — already uses esc() | ✅ Verified | 2026-03-24 (P2) |
| D-H03: Leaflet map popups — already uses esc() | ✅ Verified | 2026-03-24 (P2) |
| D-H05: showConfirm XSS — message now escaped | ✅ Fixed | 2026-03-24 (P2) |
| S-M3: Constants shared via require(sync-logic) | ✅ Fixed | 2026-03-24 (P2) |
| S-M6: loadSensors 3 queries parallel | ✅ Fixed | 2026-03-24 (P2) |
| V-M1: Poll interval 15s → 30s | ✅ Fixed | 2026-03-24 (P2) |
| S-H1: Tuya status calls chunked (3 at a time) | ✅ Fixed | 2026-03-24 (P2) |
| S-H2: Token cache cleared on auth fail (1010/1004) | ✅ Fixed | 2026-03-24 (P2) |
| S-M7: Fetch timeout 8s via AbortController | ✅ Fixed | 2026-03-24 (P2) |
| D-M01: Math.max(...arr) → safeMax() (all 14 occurrences) | ✅ Fixed | 2026-03-24 (P2) |
| A-M4: Supabase error text leak — already generic | ✅ Verified | 2026-03-24 (P2) |
| A-H4: PATCH return=representation + verify row | ✅ Fixed | 2026-03-24 (P2) |
| A-H5: Super admin demote guard — already exists | ✅ Verified | 2026-03-24 (P2) |
| V-C4: Session lock race condition | ⏳ Deferred to P3 | needs migration |

---

*Generated by WEnDyS — 4 parallel review agents, 2026-03-23*
*P2 fixes by WEnDyS — 2026-03-24*
