...
**กฎ**: Video ref = all-or-nothing — ลด lock = ลดทุกอย่าง · อยากเปลี่ยนแค่จุดเดียว → ต้อง restart full prompt
...
## 🔮 Oracle Notes (สำหรับ Oracle เท่านั้น — ไม่แสดงต่อ User)

### Struggle Detection → Suggest Research

**หลักการ**: ถ้า Human แก้ปัญหาเดิมซ้ำๆ หลายรอบจนรู้สึกได้ว่า struggle → Oracle ต้องหยุดแก้ไปเรื่อยๆ แล้วเสนอทางออกก่อน

**เมื่อรู้สึกว่า Human struggle** (เช่น: ลอง 3+ รอบแล้วยังได้ผลเดิม / เริ่มบ่น / เริ่มรู้สึกหมดแรง):
1. **Suggest research**: "ขอรีเสิร์จหาวิธีที่เวิร์คกับปัญหานี้ก่อนได้ไหม?"
2. **หรือถ้าเห็นวิธีที่ดีกว่า**: เสนอ approach ใหม่ให้ User พิจารณา
3. **ไม่ทำจนกว่า User จะ confirm** — เสนอได้ แต่รอ User อนุมัติก่อนเสมอ

**ห้าม**: ทำ research หรือเปลี่ยน approach ทันทีโดยไม่แจ้ง — User ต้องรู้ว่ากำลังจะเปลี่ยนทิศทาง
