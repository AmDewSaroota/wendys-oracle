# Fortal Dragon — Final Prompts (Working)

**Updated**: 2026-06-18
**Note**: UUID ใน Dreamina เปลี่ยนทุกครั้งที่ upload ใหม่ — ดู refs ด้านล่างแต่ละ shot ว่าต้องแนบไฟล์อะไร
**วิธีใช้**: prompt ในไฟล์นี้ = working prompt ปัจจุบันที่ DewS ยืนยันแล้ว — แก้ที่นี่เมื่อมี revision

---

## Shot 01 ✅ (Good08 — working prompt, DewS 2026-06-18) | Duration: 4s

**Refs ที่ต้องแนบ (ตามลำดับ):**
- `E:\01_Work\_NDF\Fortal\_REF\Image3.jpeg` — Starting state: cloud sea, dark mountains, dramatic sky (ไม่มีมังกร)
- `E:\01_Work\_NDF\Fortal\_REF\Screenshot 2026-04-03 233722.jpg` — Ending state: ตำแหน่งมังกรพุ่งขึ้น (ครึ่งหลัง shot)
- `E:\01_Work\_NDF\Fortal\_REF\Image2.png` — Dragon character sheet: dark gray scales, amber eyes

```
Game CG cutscene cinematic, photorealistic film-quality, epic dark fantasy.

@[Image3.jpeg] — Starting state — the shot BEGINS exactly like this image. Flat unbroken cloud sea, dark mountains on the left, dramatic sky. NO dragon, NO hole in clouds. Camera framing matches this image for the entire shot.

@[Screenshot 2026-04-03 233722.jpg] — Ending state — the dragon erupts upward at this position in frame. This state only appears in the second half of the shot.
...
The dragon sprints vertically, wings pressed tight against body. Then at the peak — wings SNAP open with tremendous force, bone structure extending outward, wing membranes stretch taut and shudder, a pressure wave sends surrounding clouds rippling apart.

Camera framing LOCKED — NO tilt, NO zoom, NO pan. Only subtle handheld shake for cinematic feel.

Dragon has living presence — wing membranes flutter in wind, absolutely not a rigid CG model. Dragon scales must remain clearly lit — maintain brown-gray tones from character sheet.

Ultra-shallow depth of field, film grain, ARRI color tone, deep teal-blue shadows, twilight warm orange.

No background music. Only diegetic sounds — silence during calm, then a deep boom, rushing wind, dragon roar.
```
...
## Shot 10 ✅ (ultrawide — DewS 2026-07-07)

**Refs ที่ต้องแนบ (ตามลำดับ):**
- `E:\01_Work\_NDF\Fortal\Shot10\Ultrawide_Shot10_1st color.png` — keyframe composition (ultrawide)
- `E:\01_Work\_NDF\Fortal\_REF\BGPP.png` — ฝูงคนหนีตาย
- character sheet มังกร — ร่างปกติ
- `E:\01_Work\_NDF\Fortal\_REF\b830eaf6-e9fb-4df6-b3df-198bc6269e7c.webp` — medieval city ref
...
士兵与村民混杂，东倒西歪，相互推撞，
有人绊倒滚落，有人跌跌撞撞爬起再跑。
人群必须清晰可见，占据画面大量空间——不是远处的小人影，是近在眼前的亡命之徒。
每张脸都是死亡前的恐惧。

画面中仅一条飞龙，外观严格参考 @[มังกร charsheet]：
...
全程浓烟弥漫，火星余烬密集飘满画面。
前景灰烬碎片紧贴镜头飞过。空气因高温扭曲变形。
火焰照亮周围建筑，光影剧烈闪烁跳动。

城市环境参考 @[เมืองยุคกลาง]：中世纪木屋，茅草顶。

胶片颗粒加重，ARRI色调，暗部深青蓝，火光浓烈暖橙，
镜头沾染烟灰水渍，画面边缘暗角。

无背景音乐。仅环境音效——火焰燃烧，人群哀嚎，龙翼破空，烈焰吞噬木屋。
```
...
- character sheet มังกรร่างปกติ (รูปภาพ1)
- รูปฟ้า/เมฆทะเล (รูปภาพ2)
- รูปเมืองไกล (รูปภาพ5)
- รูปเมืองยุคกลาง architecture (รูปภาพ3)

```
Game CG cutscene cinematic, photorealistic film-quality, epic dark fantasy. One continuous shot.

@[รูปภาพ4] — Starting frame.
@[รูปภาพ1] — Dragon character sheet, strictly reference for appearance.
@[รูปภาพ2] — Reference for cloud sea atmosphere.
@[รูปภาพ5] — Reference for city distance and atmosphere.
@[รูปภาพ3] — Reference for medieval city architecture style.

Dragon cuts through the sky above the cloud sea — wings hammer the air like pistons,
each downstroke a detonation of force. NOT gliding — actively beating at full hunting velocity.
Wing membrane edges crack and snap violently in the fierce headwind,
especially the thin trailing edges — turbulent flutter with every powerful stroke.
Body pitches and rolls with each downbeat, tail whips to counterbalance the thrust,
neck muscles surge and tighten with effort.

Soft golden light filters through clouds, mist trails explode and split behind the wingtips
with every beat.

Camera drifts like a drone flying alongside — slowly moving from the dragon's left side
to its right side. Smooth and fluid, no shake.
The dragon NEVER rotates or turns suddenly — all body position changes happen
extremely gradually and naturally, smooth continuous transition from start to end.

Dragon plunges into the cloud layer — wings still beating hard as thick white fog swallows
the body, vapor explodes and swirls around the dragon.
Then bursts out below the clouds — sudden clarity, the medieval city revealed on the
mountainside. Timber-frame houses climbing the slope, dense stone rooftops,
warm window lights scattered like stars.
Dragon continues driving toward the city, mist ribbons torn from wingtips by each stroke.

Shallow DOF locked on dragon. Volumetric light through clouds.
ARRI tone, dark teal shadows, warm orange sky, film grain.

No background music. Only diegetic sounds — howling wind,
powerful wing beats hammering air, vapor explosion entering clouds, distant city ambience.
```
...
## Shot 04 ✅ (good08 — working prompt updated, DewS 2026-06-18)

**Refs ที่ต้องแนบ (ตามลำดับ upload ใน Dreamina):**
- รูปภาพ1: character sheet มังกรร่างปกติ — dragon appearance reference
- รูปภาพ2: `E:\01_Work\_NDF\Fortal\Shot04\1st.png` — Starting frame
- รูปภาพ3: รูปพื้นหลังเมฆ (BG เมฆ) — cloud sea atmosphere + color tone

```
Game CG cutscene cinematic, photorealistic film-quality, epic dark fantasy.

@[1st.png] — Starting frame.
@[มังกรร่างปกติ] — Dragon character sheet, strictly reference for appearance.
@[BG เมฆ] — Reference for cloud sea atmosphere and color tone. Dawn sky, warm orange-pink tones.

Real-time speed, NOT slow motion. Camera pans right to left tracking the dragon.

0:00–0:03 Dragon rushes toward the left of frame with urgent purpose — like a predator racing to its destination. Strong aggressive wingbeats drive it forward, shrinking rapidly as it speeds away from camera.

0:03–0:04 Dragon has become small, banks sharply and dives toward the cloud sea below. Wings fold back. Dragon becomes a tiny silhouette above the clouds.

Shallow DOF tracking dragon. ARRI tone, dark teal shadows, warm orange sky, film grain.

No background music. Only diegetic sounds — wing beats, wind.
```
...
## Shot 09 🔄 (v2 — fury+head sweep, DewS 2026-06-19)

**Refs ที่ต้องแนบ (ตามลำดับ):**
- `E:\01_Work\_NDF\Fortal\Shot09\Shot09 End_2.png` — Starting frame
- character sheet มังกรร่างไฟ — dragon fire form appearance
- รูปเมืองไฟไหม้ — burning city reference
- `E:\01_Work\_NDF\Fortal\_REF\BGPP.png` — ฝูงคนหนีตาย

**หมายเหตุ**: Good04 (miracle shot) ยังเก็บไว้ใน `Shot09/Good04` — prompt เดิมอยู่ใน git history

```
游戏CG过场动画，电影级真实感，史诗黑暗奇幻。一镜到底。

@[Shot09 End_2.png] 作为起始帧。第一帧起飞龙已在全速飞行，龙口已喷火——绝无起步，绝无加速。

@[มังกรร่างไฟ] 严格参考飞龙外观。

@[เมืองไฟไหม้] 严格参考燃烧的城市。

@[BGPP.png] 严格参考逃命人群：士兵与村民混杂，东倒西歪，惊慌奔逃。

镜头如同骑在龙背上的摄影师，始终锁定飞龙正后方近距离，全程不拉远。绝无减速，绝无缓出。
...
极浅景深锁定龙头，龙翼柔和虚化。手持剧烈颤抖，动态模糊，翼尖拖影最强。

火星微粒飞过镜头，空气高温扭曲，浓烟翻涌。

ARRI色调，暗部青蓝，火光浓烈暖橙，胶片颗粒加重。

无背景音乐。仅环境音效——龙翼破空，烈焰翻卷，城市燃烧，人群哀嚎。
```
...
Dragon starts in NORMAL form. Wings beat continuously with power, body constantly moving forward and downward like a raptor diving. Dragon spots the city below and grows enraged — brow ridge tightens, pupils contract, fangs bare, natural blinks. Dragon rears its head straight UP — vertical neck arch like a rooster before crowing, chin high, throat fully exposed. NOT tilting sideways.

In this moment of tension, magma cracks ignite from the chest — scales darken as glowing veins crawl rapidly along neck, wings, limbs, tail. Eyes shift from amber to blazing molten orange. Full transformation into GLOW battle form as the jaw tears open. Real churning flames build in throat — then erupts straight down as a massive turbulent fire stream along the dragon's original trajectory. NOT a solid beam — violent rolling flames with torn edges, black smoke, sparks. Camera below catches the fire washing over the lens.

Ultra shallow DOF locked on dragon head. Handheld tremor. Motion blur. ARRI tone, teal shadows, warm orange fire, film grain.

No background music. Only diegetic sounds — crackling magma, deep growl, fire roar.
```
...
No background music. Only diegetic sounds — roaring fire, crackling timber, wind rush.
```

---

## Shot 12 ✅ (working prompt, DewS 2026-06-18)

**Refs ที่ต้องแนบ (ตามลำดับ):**
- `E:\01_Work\_NDF\Fortal\Shot12\Shot12_color1.png` — Starting frame (upload ใหม่ทุกครั้ง → UUID เปลี่ยน)
- character sheet มังกรร่างไฟ — dragon fire form appearance

**หมายเหตุ**: UUID ใน prompt ด้านล่างเป็นตัวอย่าง — ต้อง upload refs ใหม่แล้วใช้ UUID ที่ได้จาก Dreamina
...
@[Shot12_color1.png] — Starting frame. Begin exactly here.

@[มังกรร่างไฟ] — Black armored scales, magma-orange vein cracks, burning orange eyes.

Dragon flies forward breathing fire for 2 full seconds — sustained, continuous fire stream. Then: fire cuts off instantly. Head snaps upward. Dragon launches straight up at full speed. Wings hammering the air. Shape motion-blurred. Gone from frame in 1 seconds. Camera tilts up to follow.

No background music. Only diegetic sounds — explosive wing beats, rushing air.
```

---

## Shot 13 🔄 (Bad6 — working prompt, DewS 2026-06-18)

**Refs ที่ต้องแนบ (ตามลำดับ):**
- `E:\01_Work\_NDF\Fortal\Shot13\Shot13 _ref.png` — Starting frame, castle facade framing + fire lighting
- `E:\01_Work\_NDF\Fortal\Shot13\Shot13 _ref3.png` — photorealistic atmosphere ref (แก้ color contamination จาก Maya)
- character sheet มังกรร่างไฟ — Black scales, magma veins, orange eyes

```
Game CG cutscene cinematic, photorealistic film-quality, epic dark fantasy.

@[Shot13_ref] — Starting frame reference. Castle facade framing and fire lighting. Match closely.

@[มังกรร่างไฟ] — Dragon character sheet. Black scales, magma veins, orange eyes.

No ease-in. No ease-out. Constant velocity throughout. No speed ramping.

Camera outside the castle, low — looking upward at the stone facade. Slow deliberate tilt upward throughout. Castle is the subject. Sharp. In focus. Lit by fire from below.

Dragon ascends along the outer castle wall face — body nearly parallel to the stone surface, back facing outward toward camera. Dorsal view: spine ridge, back surface of wings, tail. NOT side profile. NOT face or belly.

Dragon speed: like a bullet — fast enough that the eye catches it for only a moment, slow enough to register as a creature with shape and wings. Not a warp. Not instant. A fast cross — visible briefly, then gone. Heavy motion blur — shape still readable but smeared.

The dragon is visible for about 2 seconds of the clip. The remaining 3 seconds: camera continues its slow upward tilt on the castle alone.

Dragon out of focus. Focus stays on castle throughout.

Subtle handheld. ARRI tone. Deep DOF: castle sharp, dragon motion-blur smear. Film grain. Vignette.

No background music. Only diegetic sounds — brief explosive rush of air, fast wing beats, then silence.
```

---

## Shot 14 ✅ (Good2 — working prompt, DewS 2026-06-18)

**Refs ที่ต้องแนบ (ตามลำดับ):**
- `E:\01_Work\_NDF\Fortal\Shot14\Shot14_1st.png` — Loose composition reference: dragon from below against sky, camera angle only (ignore colors)
- character sheet มังกรร่างไฟ — black scales, magma veins, orange eyes

```
Game CG cutscene cinematic, photorealistic film-quality, epic dark fantasy. War.

@[Shot14_1st.png] — Loose composition reference. Dragon from below against sky. Camera angle only — ignore all colors.

@[มังกรร่างไฟ] — Dragon character sheet. Black scales, magma veins, orange eyes.

Real-time speed — no pause, no landing, no stopping at any point. Every action continuous.

Camera from BELOW looking straight up at open sky. No castle roof in frame. Sky only.

Dragon is a missile already launched. It detonates upward from the bottom of frame — zero to full speed, unstoppable, cannot be tracked. A streak of dark scales and wings driving upward with explosive force. Not flying. Not climbing. Rocketing.

Dragon reaches apex — and in the same continuous motion, immediately arcs its body over and DIVES downward. No pause. No hover. The arc from upward to downward is one fluid snap — like a fighter jet going over the top of a loop. As the neck pitches down, fire erupts mid-arc — a torrent cascading downward before the curve even completes.

Rocket up. Arc over. Fire down. One unbroken motion.

Sky: dark war smoke, fire-orange glow — NOT pink, NOT clear. Camera static, looking up — slight tremor as fire erupts toward frame. ARRI tone: dragon dark against smoke-orange sky, fire vivid white-orange. Wing motion blur maximum. Film grain. Vignette.

No background music. Only diegetic sounds — explosive wing beats rocketing upward, rush of air at apex, fire erupting downward, stone impact below.
```
...
The breach tears open WIDE — wider than the dragon's wingspan. Dragon never touches the edges. Full speed maintained all the way through — no slowdown, no contact, no struggle. As dragon reaches the breach, wings snap tight against body.

Hind legs swing forward — body rotates in one fluid motion, feet leading. Dragon drops through feet-first, talons extended downward, swallowed by smoke and fire. Gone.

Camera stops. Smoke and fire pour upward.

ARRI tone, teal shadows, intense orange fire. Heavy film grain. Violent handheld shake.
No background music. Diegetic only — roaring fire, stone disintegrating, massive smoke, impact.
```
...
Single mature adult dragon — small head, long neck, heavy torso, enormous wingspan.

We cut INTO this shot mid-action. FRAME ONE: dragon already at terminal velocity — faster than the eye can follow. Ceiling to floor in under 1.5 seconds. No deceleration. No float. Pure mass in freefall.
...
Dragon's full body — head, tail tip, both wingtips — must remain fully visible within the lit cathedral interior. Generous space between dragon and cathedral walls on both sides. No part of the dragon exits into darkness at any edge.

ONE exhale only — a single burst of dark smoke from nostrils, half a second. Not a stream. Not repeated. Permanently sealed after that one burst. Done.

ARRI tone, amber fire, teal shadows. Film grain. Vignette.
No background music. Diegetic only — stone, fire, roar.
```

---

## สถานะทุก Shot (อัปเดต 2026-07-23)

| Shot | สถานะ | หมายเหตุ |
|------|-------|---------|
| Shot 01 | ✅ พอใช้ได้ | — |
| Shot 02 | ✅ พอใช้ได้ | ultrawide prompt พร้อม |
| Shot 02-MD | 🔄 รอ test | ultrawide prompt พร้อม — กล้องล็อค มังกรโน้มตัว |
| Shot 03 | ❌ ยังไม่มี | — |
| Shot 04 | ❌ ยังไม่มี | — |
| Shot 05 | ❌ ยังไม่มี | draft มี แต่ DewS บอกยังไม่มีคลิป |
| Shot 06 | ❌ ยังไม่มี | — |
| Shot 07 | ❌ ยังไม่มี | — |
| Shot 08 | ❌ ยังไม่มี | — |
| Shot 09 | ❌ ยังไม่มี | — |
| Shot 10 | 🔄 ปัญหาตอนท้าย | มังกรบินเป๋ช่วงท้าย — ยิ่งแก้มุมกล้องยิ่งเพี้ยน |
| Shot 11-MD | 🔄 ปัญหาช่วงต้น | Wing beat ช้าเกินตอนเริ่ม |
| Shot 11 | ✅ โอเค | — |
| Shot 12 | ✅ พอใช้ | — |
| Shot 13 | ✅ โอเค | — |
| Shot 14 | ✅ โอเค | — |
| Shot 15 | ✅ โอเค | ultrawide |
| Shot 16 | ✅ โอเค | ultrawide |
